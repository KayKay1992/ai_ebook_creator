...
const Hero = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-gray-50 via-white to-accent-50 pt-20 pb-16 lg:pt-28 lg:pb-24">
      
      {/* Floating Background Elements */}
      <div className="absolute top-10 left-10 w-72 h-72 bg-accent-300/20 rounded-full blur-3xl animate-pulse-slow"></div>
      <div className="absolute bottom-20 right-12 w-96 h-96 bg-accent-secondary-300/20 rounded-full blur-3xl animate-pulse-slow delay-1000"></div>
      ...
      <div className="absolute -top-12 -left-12 w-52 h-52 bg-accent-400/10 rounded-3xl rotate-12 blur-2xl"></div>
      <div className="absolute -bottom-16 -right-20 w-64 h-64 bg-accent-secondary-400/10 rounded-full blur-3xl"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 bg-white rounded-2xl px-4 py-2 shadow-sm border border-accent-100">
              <Sparkles className="w-5 h-5 text-accent" />
              <span className="text-sm font-semibold text-accent-hover tracking-wide">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                ...
                className="group inline-flex items-center gap-3 bg-gradient-to-r from-accent to-accent-secondary text-white px-8 py-4 rounded-2xl font-semibold text-lg shadow-xl shadow-accent-500/30 hover:shadow-2xl hover:scale-105 transition-all duration-300"
              >
          ...
          <div className="relative flex justify-center">
            <div className="relative">
              <div className="relative bg-white rounded-3xl shadow-2xl shadow-accent-500/20 overflow-hidden border border-gray-100">
                <img
                  src={HERO_IMAGE}
                ...
                <div className="absolute -top-6 -right-6 bg-white/70 backdrop-blur-xl border border-white/60 rounded-3xl shadow-2xl p-6 max-w-[270px] hover:bg-white/90 transition-all duration-500 hover:scale-[1.03] hover:shadow-accent-500/30 group">
              ...
              {/* Main Glow Layer */}
              <div className="absolute inset-0 bg-gradient-to-br from-accent-400/20 via-accent-secondary-400/20 to-transparent -z-10 blur-3xl rounded-[4rem]"></div>
            </div>
          </div>
        </div>
      </div>
